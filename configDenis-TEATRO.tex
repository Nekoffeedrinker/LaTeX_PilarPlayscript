...
%\titlespacing{\section}{\PsepLSection}{\PsepTSection}{\PSepBSection} % 
%%Espaciado de la sección
%\titlespacing{\subsection}{\PsepLSubsec}{\PsepTSubsec}{\PSepBSubsec} % 
%%Espaciado de la subsección

\usepackage{titlesec}

%\titleformat{\subsection}
%{\centering\rmfamily\large\bfseries} % Formato del título: centrado, tamaño 
%%grande, negritas
%{}                       % Número de subsección | Para activarlo: 
%%\thesubsection
