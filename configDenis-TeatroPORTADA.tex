...
%	\node[inner sep=0pt,anchor=south,opacity=0.5] at ([shift={(0,30mm)}]tituba) {\includegraphics[height=80mm]{anexos/img-portada_Bunny.png}};
	...
	\node[inner sep=0pt,anchor=north] at (title) {\includegraphics{LaTeX_PilarPlayscript/vector-portada_Marco_luces.pdf}};
	...
	\node[inner sep=0pt,anchor=north] at ([shift={(0,-40mm)}]title) {
		\begin{minipage}[m][50mm]{140mm}
			...
			{\fontsize{16}{18}\selectfont \rmfamily \scshape \superencabezado}
			
			\vspace{2pt}
			{\fontsize{35}{40}\selectfont \rmfamily \bfseries\itshape 
			\encabezado}
			\vspace{2pt}
	...
	\node[inner sep=0pt,anchor=south] at (tituba) {\includegraphics[height=20mm]{LaTeX_PilarPlayscript/vector-TITUBA_Expand_1inkB.pdf}};
\end{tikzpicture}
